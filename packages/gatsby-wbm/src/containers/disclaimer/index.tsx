...
import { DisclaimerWrapper, DisclaimerDetails } from './style'
...
const Disclaimer: React.FunctionComponent<DisclaimerProps> = () => {
  return (
    <DisclaimerWrapper>
      <DisclaimerDetails>
        <h1>Disclaimer for WebBrainsMedia</h1>
        ...
        <h2>Disclaimers for WebBrainsMedia</h2>

        <p>
          All the information on this website - https://webbrainsmedia.com/ - is
          published in good faith and for general information purpose only.
          WebBrainsMedia does not make any warranties about the completeness,
          reliability and accuracy of this information. Any action you take upon
          the information you find on this website (WebBrainsMedia), is strictly
          at your own risk. WebBrainsMedia will not be liable for any losses
