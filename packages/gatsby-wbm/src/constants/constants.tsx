const Constants = {
  quotes: [
    ...
    {
      quote: 'Make the most of the best and the least of the worst.',
    ...
    {
      quote: 'Outer order contributes to inner calm.',
    ...
    {
      quote: 'If you want to awaken all of humanity, awaken all of yourself.',
      author: 'Lao Tzu',
    },
    {
      quote:
    ...
    {
      quote: 'One man or woman with courage is a majority.',
      author: 'Unknown',
    },
    {
      quote:
